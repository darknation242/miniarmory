	...
	for(i=0; i<divs.length; i++) {
		if(divs[i].className == 'iconmedium') {
			...
			a.onmouseover = function() {
				...
				tooltip('<span class="tooltip-header">'+talentName[this.id]+' (Rank '+this.rank+')</span><br><span class="description">'+talentDescription[this.id]+'</span>');
			};
